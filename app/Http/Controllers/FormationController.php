...
class FormationController extends Controller
{
    public function index(){
        ...
        return view('frontEnd.formation',compact('products'));
    }
    ...
    public function detialpro($id){
        ...
        return view('frontEnd.formation_details',compact('detail_product','imagesGalleries','totalStock','relateProducts'));
    }
