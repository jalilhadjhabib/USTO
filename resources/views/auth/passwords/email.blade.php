  ...
  <div class="wrapper row1">
    <header id="header" class="hoc clear"> 
      <div id="logo" class="fl_left">
          <a href="/"><img src="{{ asset('images/snv_logo.png') }}" align=left style="width: 80px;"><h1 id="logo_name">S N V</h1></a>
      </div>
      <br>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-0">
                                <center><input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required style="background: #F0F0E9;
    border: medium none;
    color: #696763;
    display: block;
...
<div class="wrapper row4">
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="group">
      ...
      <div class="one_quarter" style="position: relative;left: 160px;">
      ...
      <div class="one_quarter" style="position: relative;left: 300px;">
