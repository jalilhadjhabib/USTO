...
<div class="bgded overlay" style="background-image:url('images/snv_banner.jpg');"> 
  ...
  <div id="conL" class="hoc clear"> 
    <div class="table-responsive">
    	<center><h1 style="font-size:50px;">Affichage des notes</h1></center>
                <form method="post" id="dynamic_form">
                 <span id="result"></span>
                 <table class="table table-bordered table-striped" id="user_table" >
               <thead>
                <tr>
                    <center><th width="35%" style="background-color: #212121;color: white;">Nom et Prénom</th></center> 
                    <th width="35%" style="background-color: #212121;color: white;">Note</th></center> 
               ...
               <thead>
                  @foreach($dynamic_field as $row)

               <tr>
                    <th width="35%">{{$row->first_name}}</th>
                    <th width="35%">{{ $row->last_name}}</th>
