...
<div class="bgded overlay" style="background-image:url('{{asset('images/snv_banner.jpg')}}');"> 
  ...
  <div id="conL" class="hoc clear"> 
    <div class="table-responsive">
    	<center><h1 style="font-size:50px;">Affichage des cours</h1></center>
	...
	<td style="color: black;"> <a href="/files/{{$data->id}}">View</a></td>
	<td style="color: black;"><a href="/files/download/{{$data->file}}">Download</a></td>
	</tr>
