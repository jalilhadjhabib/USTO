...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Acceuil</a> <a href="{{route('category.index')}}">Catégorie</a> <a href="#" class="current">Modifier la catégorie</a> </div>
