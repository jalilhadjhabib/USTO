...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Acceuil</a> <a href="{{route('category.index')}}">Catégories</a> <a href="{{route('category.create')}}" class="current">Ajoutez une nouvelle catégorie</a> </div>
