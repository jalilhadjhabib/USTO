...
<style type="text/css"></style>
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Accueil</a> <a href="#" class="current">Paramètre</a> </div>
    </div>
    <!--End-breadcrumbs-->
            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
                        ...
                        @else
                            <h5>Validation de la sécurité</h5>
                        @endif
                    </div>
