...
@section('title','Ajouter une nouvelle photo')
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Acceuil</a> <a href="{{route('product.index')}}">Formations</a> <a href="#" class="current">Ajouter une Images Gallery</a> </div>
    <div class="container-fluid">
        @if(Session::has('message'))
            <div class="alert alert-success text-center" role="alert">
                <strong>Bien fait &nbsp;</strong>{{Session::get('message')}}
            </div>
        @endif
        <div class="row-fluid">
            <div class="span6">
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"> <i class="icon-file"></i> </span>
                        <h5>Formation : {{$product->p_name}}</h5>
                    </div>
                        ...
                        <ul class="recent-posts">
                            <li>
                                ...
                                <div class="article-post">
                                    <span class="user-info">Formation Code : <b>{{$product->p_code}}</b></span>
                                    <p>Formation ID : <b>{{$product->p_color}}</b></p>
                                </div>
                            </li>
                            <li>
