...
@section('title','Ajouter une nouvelle formation')
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Acceuil</a> <a href="{{route('product.index')}}">Formation</a> <a href="{{route('product.create')}}" class="current">Ajouter une nouvelle formation</a> </div>
            ...
            <div class="widget-content nopadding">
                <form action="{{route('product.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        <label class="control-label">Selectionner la catégorie</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label for="p_color" class="control-label">ID</label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls{{$errors->has('price')?' has-error':''}}">
                            <div class="input-prepend"> <span class="add-on">Numéro de la formation</span>
                    ...
                    <div class="control-group">
                        <label class="control-label">Image de la formation</label>
                        <div class="controls">
