...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('product.index')}}">Formations</a> <a href="#" class="current">Add Attribute</a> </div>
                            ...
                            <ul class="recent-posts">
                                <li>
                                    ...
                                    <div class="article-post">
                                        ...
                                        <p>Formation Color : <b>{{$product->p_color}}</b></p>
                                    </div>
                                </li>
                                <li>
