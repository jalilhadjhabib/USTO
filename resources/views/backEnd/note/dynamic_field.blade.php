...
$(document).ready(function(){
 ...
 {
  html = '<tr>';
        html += '<td><input type="text" name="first_name[]" class="form-control" style="color: black;"/></td>';
        html += '<td><input type="text" name="last_name[]" class="form-control" style="color: black;" /></td>';
        if(number > 1)
        {
...
$(document).on('click', '.delete', function(){
  ...
  {
   $.ajax({
            url:'{{ route("dynamic-field.delete_data") }}',
    method:"POST",
